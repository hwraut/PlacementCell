...
<textarea name="details" required rows="5" cols="40" value="." class="form-control"></textarea><br><br>


<span style="color:black;">Company Head Office Location:</span>
<input type="text" required name="loc" class="form-control">
<br>

<span style="color:black;">Company Website:</span>
<input type="text" required name="Website" class="form-control">
<br>

<span style="color:black;">Company Contact:</span>
<input type="text"required name="Contact" class="form-control">
<br>

<span style="color:black;">Company Email:</span>
<input type="text" required name="Email" class="form-control">
<br>

<span style="color:black;">Company Technology Details:</span>
