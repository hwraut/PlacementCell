                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Delete Student</h1>                            </div>
<?php        
		if(isset($_GET['id1']))
		{
		if($_GET['id1']=="done")
		{
		echo "<center><span style='color:red'><strong>User Deleted</strong></span></center>";
		}
		if($_GET['id1']=="notdone")
		{
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                ...
                                <h2 class="title pull-left">Delete Student From List</h2>
  ...
  $sql = $obj->db->prepare("select * from student");
		...
		$sql->execute();
			...
			?> 
                      ...
                      <td><a href="View-Delete-user.php?id=<?php echo $row['ID']; ?>" class="btn btn-danger">Delete User</a></td>
...
{
	echo "<script>window.location='View-Delete-user.php?id1=done';</script>";
}
