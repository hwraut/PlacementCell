...
<?php        
		...
		if($_GET['id1']=="done")
		{
		echo "<center><span style='color:red'><strong>Students Approved Succesfully!!</strong></span></center>";
		}
		if($_GET['id1']=="notdone")
		{
...
$obj= new Connections();			
$sql = $obj->db->prepare("select * from student where status='0' ORDER BY ID DESC");
