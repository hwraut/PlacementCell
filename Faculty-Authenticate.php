                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Approve Faculty Listing</h1>                            </div>
<?php        
		if(isset($_GET['id1']))
		{
		if($_GET['id1']=="done")
		{
		echo "<center><span style='color:red'><strong>Faculty Approved Succesfully!!</strong></span></center>";
		}
		if($_GET['id1']=="notdone")
		{
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                ...
                                <h2 class="title pull-left">Approve Faculty's  List</h2>
  ...
  $sql = $obj->db->prepare("select * from faculty where status='0'");
		...
		$sql->execute();
			...
			?> 
                        ...
                        <td><a href="Faculty-Authenticate.php?id=<?php echo $row['ID']; ?>" class="btn btn-info">Approve</a></td>
...
if($obj->Update($id,$table)==1)
{
  ...
  $obj= new Connections();
  $sql = $obj->db->prepare("select * from faculty where ID='$id'");
  $sql->execute();
  while($row = $sql->fetch(PDO::FETCH_ASSOC)) {

 echo $moblies=$row['contact'];
	...
	echo "<script>window.location='Faculty-Authenticate.php?id1=done';</script>";
}
