                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Subject Details</h1>                            </div>
                   ...
                   <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Add Subject</h2>
...
<form action="" method="POST" enctype="multipart/form-data"> 
 ...
 <label style=" float:left;margin-right:3%;"> Branch</label>
  ...
  include 'Application/DB_Functions.php';
    $obj= new Connections();
 $sql1 = $obj->db->prepare("select * from  branch");
	$sql1->execute();
		
?> 

<select name="branch" class="form-control" required style="width:40%;">
<option value="">Select Branch</option>
 <?php while($row1 = $sql1->fetch(PDO::FETCH_ASSOC)) {
 ?>
 <option value="<?php echo $row1['ID']; ?>"><?php echo $row1['branchs']; ?></option>
 ...
 <?php } ?>
   ...
   <label style=" float:left;margin-right:3%;"> Subject Name</label>
    <input type="text"  autocomplete="off" required style="width:40%; float:left; margin-right:3%;" placeholder="Subject" name="subject" value="" class="form-control">
...
if($obj->Add_subject($branch,$subject,$sem)==1)
{	
