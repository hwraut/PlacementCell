...
--
-- Host: localhost
-- Generation Time: Feb 24, 2020 at 07:58 AM
...
CREATE TABLE IF NOT EXISTS `company` (
  ...
  `company_details` varchar(999) NOT NULL,
  `company_headoffice_loc` varchar(999) NOT NULL,
  `company_website` varchar(999) NOT NULL,
  `company_contact` varchar(999) NOT NULL,
  `company_email` varchar(999) NOT NULL,
  `technology_details` varchar(999) NOT NULL,
  PRIMARY KEY (`ID`)
...
INSERT INTO `company` (`ID`, `company_name`, `company_details`, `company_headoffice_loc`, `company_website`, `company_contact`, `company_email`, `technology_details`) VALUES
(4, 'www.imaginescript.com', 'as', 'as', 'as', 'as', 'asd@sdfsdf.sdf', 'asas');
...
(9, 'Anvika', 'Dhole', 'admin', '6c9cdce9f6d927cea4c621b33ca05013', '', '', '', 1, 'CS'),
(10, 'Ram', 'Doe', 'ram@gmail.com', '6a557ed1005dddd940595b8fc6ed47b2', '', '', '', 1, 'CS');
...
(2, 'TCS Open Campus March 2020', 'Walk in Interview in P.R. POTE College of TCS ', '2020-02-01 15:45:18'),
(5, 'Infosys Open Campus March 2020', 'Walk in Interview Infosys in P.R. POTE College ', '2020-02-01 15:46:31'),
(6, 'Capgimini Walk-in Interview in Feb 2020', 'Interview in Feb 2020', '2020-02-01 15:48:53');
...
CREATE TABLE IF NOT EXISTS `profile` (
  ...
  `tenthper` varchar(999) NOT NULL,
  `twelthper` varchar(999) NOT NULL,
  `fst` varchar(999) NOT NULL,
  `second` varchar(999) NOT NULL,
  `third` varchar(999) NOT NULL,
  `fourth` varchar(999) NOT NULL,
  `branchh` varchar(999) NOT NULL,
...
INSERT INTO `profile` (`ID`, `user_id`, `school`, `passout`, `highschool`, `highschool_passout`, `tenthper`, `twelthper`, `fst`, `second`, `third`, `fourth`, `branchh`, `currently_working`, `lives_in`, `from`, `hobby`, `pic`) VALUES
(14, '1', '1', '1', '1', '1', '65', '75', '1', '11', '1', '1', '1', '1', '11', '1', '1', '1'),
(15, '18', 'asda', '1941', 'asdasd', '1941', '60', '53', '123', '12', '12', '12', 'Electronics', '', 'asd', 'asdasd', 'asd', '02182020063054-aboutpic2 (1).jpg'),
(16, '18', 'asda', '1941', 'asdasd', '1941', '55', '65', '123', '12', '12', '12', 'Electronics', '', 'asd', 'asdasd', 'asd', '02182020063152-aboutpic2 (1).jpg'),
(17, '18', 'asda', '1931', 'asdasd', '1941', '80', '85', '123', '123', '123', '123', 'Information Technology', '', '123', '123', '123', '02182020063241-aboutpic2.jpg'),
(18, '18', 'asda', '1931', 'asdasd', '1941', '65', '66', '123', '123', '123', '123', 'Information Technology', '', '123', '123', '123', '02182020063351-aboutpic2.jpg');
...
(15, '502332', 'ram', 's', 'sharma', 'ram@gmail.com', 'ram123', '8237783265', '2', '2', 'PRMIT', 'Old Byepass dastur nagar Amravati', 'Amravati', 'Male', '2016-03-11', '1', '0'),
...
(18, '974473', 'Anvika', '', 'Dhole', 'anvika@gmail.com', 'anvika123', '9890545671', '', '2', 'Bhartiya Mahavidyalaya Amravati', 'Farshi Stop', 'Amravati', '', '', '1', '0');
