...
<?php        
  ...
  $sql = $obj->db->prepare("select * from faculty where status='1'");
		...
		$sql->execute();
			...
			?> 
                      ...
                      <td><a href="View-Delete-faculty.php?id=<?php echo $row['ID']; ?>" class="btn btn-danger">Delete User</a></td>
...
{
	echo "<script>window.location='View-Delete-faculty.php?id1=done';</script>";
}
